...
public class EditorActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        itemPic = (ImageView) findViewById(R.id.image_view);
    ...
    private void saveitem() {
        ...
        values.put(ItemEntry.COLUMN_IMAGE, picUri);
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor cursor) {
        ...
        if (cursor.moveToFirst()) {
            ...
            int itemPicColumnIndex = cursor.getColumnIndex(ItemEntry.COLUMN_IMAGE);
            ...
            String imageString = cursor.getString(itemPicColumnIndex);
