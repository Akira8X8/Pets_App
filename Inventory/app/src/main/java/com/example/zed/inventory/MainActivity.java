...
import com.example.zed.inventory.data.ItemDbHelper;
...
public class MainActivity extends AppCompatActivity implements
    ...
    private void insertItem() {
        ...
        // and the ladder's item attributes are the values.
        ContentValues values = new ContentValues();
        values.put(ItemEntry.COLUMN_ITEM_NAME, "Ladder");
        values.put(ItemEntry.COLUMN_ITEM_TYPE, ItemEntry.TYPE_FACTORY);
        values.put(ItemEntry.COLUMN_ITEM_PRICE, 100);
        values.put(ItemEntry.COLUMN_ITEM_WEIGHT, 70);
        values.put(ItemEntry.COLUMN_ITEM_QUANTITY, 1);
        values.put(ItemEntry.COLUMN_SUPPLIER_NAME, "Factory 1");
        values.put(ItemEntry.COLUMN_SUPPLIER_PHONE, 1234567890);
        values.put(ItemEntry.COLUMN_SUPPLIER_EMAIL, "one@factory.com");
        values.put(ItemEntry.COLUMN_IMAGE, "android.resource://com.example.zed.inventory/drawable/ic_done");
    ...
    public void mainSale(long id, int quantity) {
        dbHelper.sellItem(id, quantity);
        madapter.swapCursor(dbHelper.findItems());
    }
}
